...
/// «удалил и залил заново», а подмена содержимого с сохранением размера и даты — от
/// «не менялся». Без него переименование папки с гигабайтами видео стоило бы
...
class LocalFile {
  ...
  /// Размер и дата изменения на момент обхода: по этой паре (вместе с [inode]) сверка решает,
...
class MirrorRow {
  ...
  ///
  /// Меняются только эти два поля: запись в облаке ([entryId]), номер файла и слепок
