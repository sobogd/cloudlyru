...
/// возвращения из системных настроек): сам доступ спрашивается у моста к Android.
...
class SyncController extends ChangeNotifier {
  ...
  ///
  /// Побочные эффекты: опрос моста, при выданном доступе — постановка наблюдения за папками
