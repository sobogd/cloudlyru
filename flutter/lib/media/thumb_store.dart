...
/// (`thumbs/100/…`), поэтому после смены размера на сервере старый каталог перестаёт
/// находиться и миниатюры скачиваются заново — старые 50×50 не подмешиваются к новым.
const int kThumbSize = 100;
