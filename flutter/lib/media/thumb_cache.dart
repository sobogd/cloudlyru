...
class ThumbCache {
  ...
  /// Сколько загрузок идёт одновременно. Четыре — компромисс: канал занят не только
  /// миниатюрами, а сервер считает каждый запрос (проверка владельца + отдача объекта).
