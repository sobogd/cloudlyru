...
/// Отступ раскладки: поле вокруг карточек и промежуток между ними в разделе «список — деталка»,
/// а также боковое поле иконок в левом баре разделов.
///
/// Одно значение на все эти места намеренно: бар, карточки и края экрана должны стоять на
/// одной сетке, а не каждый со своим отступом. Промежуток между карточками — два таких поля
/// (см. `util/master_detail.dart`), и он же равен расстоянию от иконок бара до первой карточки.
const double kPaneGutter = 12;
