...
///
/// Отдельный раздел в левом баре, рядом с «Чатом»: разделы родственные, но разные — чат
...
///
/// Список проектов живёт в своём провайдере (`agentProjectsProvider`) и от «Чата» не зависит
/// ничем: раздел был вынесен из шапки чата и остался самодостаточным.
///
