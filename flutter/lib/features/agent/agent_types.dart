...
///
/// «Вернулось» — не ошибка моста, а живой процесс: у Claude Code разговор, который ведёт
/// `remote-control` или открытый терминал, заново пишет свой журнал сразу после удаления. Такие
/// разговоры удаляются не из приложения, и человеку надо сказать это словами.
