...
class AiChunk {
  ...
  /// Агент работает на телефоне (`true`) или закончил (`false`); `null` — событие не об этом.
  ///
  /// Отдельно от [searching], а не тем же полем: прогон агента идёт минутами, и подпись должна
  /// говорить именно про телефон. С общим полем человек читал бы «ищу в интернете» там, где на
  /// самом деле работает устройство, и не понимал бы, чего он ждёт.
