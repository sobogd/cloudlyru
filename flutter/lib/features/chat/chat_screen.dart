        ...
        child: Padding(
          ...
          child: Text(
            state.configured
                ...
                : 'Чат появится, когда сервер увидит машину с локальной моделью.',
    ...
    return Panel(
      child: Row(
        ...
        children: [
          ...
          const Expanded(
            child: Text(
              'Локальная модель недоступна: сервер не видит машину, на которой она считает. '
              'Обычно это значит, что мак спит или выключен — раздел заработает сам, когда он '
              'вернётся.',
