...
class GallerySync {
  ...
  /// Сколько страниц наполнения читаем за один заход. Проход продолжается при следующем
  /// открытии раздела, а не занимает канал и поток на минуты: галерея уже наполовину рабочая.
  static const int _pagesPerRun = 30;
