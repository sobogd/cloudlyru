...
на маке или удалённый провайдер по API. Ключи от API лежат только на маке (`~/.pi/agent/auth.json`
или `models.json`) и в сборку приложения не попадают — как добавлять провайдеров, написано в
