 ...
 *
 * Сам поиск делает не сервер и не модель, а маленький сервис на маке
 * (`jevel.ai/agents/search-server.py`, за туннелем на 127.0.0.1:18814). Причина ровно одна:
 * поисковые запросы должны уходить с домашнего IP. Датацентровые диапазоны DuckDuckGo
 * встречает капчей, домашние — нет, и проверено это на живых запросах с обоих адресов.
 *
