...
const envSchema = z.object({
  ...
  // Язык распознавания для whisper (`ru`, `en`, ...). Пусто — автоопределение: в русской речи
  // бывают английские вставки, и жёсткий `ru` заставляет модель озвучивать их по-русски.
