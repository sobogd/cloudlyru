...
const envSchema = z.object({
  ...
  // папке проекта — читает и правит файлы, запускает команды. Приходит сюда тем же reverse-SSH
  // туннелем, что модель и поиск, поэтому адрес — loopback самого VPS: снаружи порт не смотрит
