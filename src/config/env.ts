...
const envSchema = z.object({
  ...
  // на случай разорванного соединения и потерянных событий. 30 с — компромисс между
  // «письмо видно почти сразу» и лишними IMAP-командами/записями в статусе.
  MAIL_SYNC_INTERVAL_SEC: z.coerce.number().int().positive().default(30),
