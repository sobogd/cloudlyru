...
Личное self-hosted облако: сервер на VPS, веб-клиент, Android-клиент для автозагрузки
папок телефона. Прод — <https://files.iq-factura.com>, репозиторий — `sobogd/cloudlyru`.
...
| `android/` | Android-клиент: автозагрузка выбранных папок телефона в облако, файловый браузер облака для системных «Файлов», «Поделиться», «Освободить место», обновление по кнопке |
