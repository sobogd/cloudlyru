...
class Agent:
    ...
    def run(self, task: str) -> AgentResult:
        ...
        Прогон всегда начинается с Chrome: без этой привязки агент стартует с того экрана, что
        был открыт, и спокойно начинает действовать в чужом приложении — на живом прогоне он
        оказался в приложении Google вместо браузера.
        """
        ...
        time.sleep(0.5)
        android.ensure_chrome(None, self.serial)
